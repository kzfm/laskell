...
`Simple DNS Lookups <http://docstore.mik.ua/orelly/perl/cookbook/ch18_02.htm>`_
...
`Being an FTP Client <http://docstore.mik.ua/orelly/perl/cookbook/ch18_03.htm>`_

`Network.FTP.Client <http://hackage.haskell.org/packages/archive/ftphs/1.0.5/doc/html/Network-FTP-Client.html>`_\ を使う
